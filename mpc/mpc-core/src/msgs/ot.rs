...
pub enum OTMessage {
    ...
    ExtEncryptedData(ExtEncryptedData),
}
...
///
/// In this case we send an AES-128 bits key in the regular OT message and afterwards
/// we just send a byte stream which has been encrypted by the key
#[derive(Debug, Clone)]
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
...
//         ) {
//             let base_sender_setup: crate::ot::extension::BaseSenderSetupWrapper =
//                 proto_ext_core_data
//                     .base_sender_setup
//                     .clone()
//                     .try_into()
...
//             let base_receiver_setup: crate::ot::extension::BaseReceiverSetupWrapper =
//                 proto_ext_core_data
//                     .base_receiver_setup
//                     .clone()
//                     .try_into()
...
//             let base_sender_payload: crate::ot::extension::BaseSenderPayloadWrapper =
//                 proto_ext_core_data
//                     .base_sender_payload
//                     .clone()
//                     .try_into()
