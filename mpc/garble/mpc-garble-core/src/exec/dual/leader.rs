...
pub mod state {
    ...
    #[derive(Debug)]
    /// This state is reached when the leader is about to receive and to start evaluating the garbled
    /// circuit generated by the follower
    pub struct Evaluator {
        pub(super) circ: Arc<Circuit>,
        // The garbled circuit generated by the leader
        pub(super) gc: GarbledCircuit<gc_state::Full>,
    }

    #[derive(Debug)]
    /// This state is reached when the leader is about to send a commitment to the value used
    /// for the DualEx's equality check
    pub struct Commit {
    ...
    #[derive(Debug)]
    /// This state is reached when the leader is about to receive the follower's value used
    /// for the DualEx's equality check
    pub struct Verify {
        pub(super) evaluated_gc: GarbledCircuit<gc_state::Evaluated>,
        pub(super) check: LabelsDigest,
    ...
    #[derive(Debug)]
    /// This state is reached when the leader successfully verified the follower's value used
    /// for the DualEx's equality check and is about to reveal his own value which he committed to
    /// earlier
    pub struct Reveal {
        pub(super) evaluated_gc: GarbledCircuit<gc_state::Evaluated>,
        pub(super) commit_opening: Opening,
...
impl DualExLeader<Evaluator> {
    ...
    /// Computes the value used for the DualEx's equality check
