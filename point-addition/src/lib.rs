...
pub mod mock {
    ...
    mod tests {
        ...
        async fn test_mock_share_x_coordinate() {
            ...
            let leader_share_a =
                Scalar::from_repr(*generic_array::GenericArray::from_slice(&leader_share_a))
                    .unwrap();
            ...
            let leader_share_b =
                Scalar::from_repr(*generic_array::GenericArray::from_slice(&leader_share_b))
                    .unwrap();
            ...
            let follower_share_a =
                Scalar::from_repr(*generic_array::GenericArray::from_slice(&follower_share_a))
                    .unwrap();
            ...
            let follower_share_b =
                Scalar::from_repr(*generic_array::GenericArray::from_slice(&follower_share_b))
                    .unwrap();
