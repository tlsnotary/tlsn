...
use point_addition::{mock::mock_point_converter_pair, Converter, P256};
use utils_aio::duplex::DuplexChannel;

/// A mock key exchange instance
pub type MockKeyExchange<E> = KeyExchangeCore<Converter<P256>, Converter<P256>, E>;
...
pub fn create_mock_key_exchange_pair<E: Memory + Execute + Decode + Send>(
    ...
    let (leader_pa_sender, follower_pa_recvr) = mock_point_converter_pair();
    let (follower_pa_sender, leader_pa_recvr) = mock_point_converter_pair();
