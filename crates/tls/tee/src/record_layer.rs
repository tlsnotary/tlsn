...
use crate::{error::Kind, TeeTlsError};
...
impl Encrypter {
    ...
    pub(crate) async fn set_key(&mut self, key: ValueRef, iv: ValueRef) -> Result<(), TeeTlsError> {
        self.aead.set_key(key, iv).await.map_err(|e| {
            TeeTlsError::new_with_source(Kind::Encrypt, "error setting encryption key", e)
        })?;

        Ok(())
    }

    pub(crate) async fn preprocess(&mut self, len: usize) -> Result<(), TeeTlsError> {
        self.aead
            .preprocess(len)
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Encrypt, "preprocess error", e))?;

        Ok(())
    }

    pub(crate) async fn setup(&mut self) -> Result<(), TeeTlsError> {
        self.aead
            .setup()
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Encrypt, "setup error", e))?;
    ...
    pub(crate) async fn encrypt_private(
        &mut self,
        msg: PlainMessage,
    ) -> Result<OpaqueMessage, TeeTlsError> {
        let PlainMessage {
            typ,
            version,
            payload,
        ...
        let ciphertext = self
            ...
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Encrypt, "encrypt_private error", e))?;
    ...
    pub(crate) async fn encrypt_blind(
        ...
        self.aead
            ...
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Encrypt, "encrypt_blind error", e))?;
    ...
    pub(crate) async fn encrypt_public(
        ...
        let ciphertext = self
            ...
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Encrypt, "encrypt_public error", e))?;
...
impl Decrypter {
    ...
    pub(crate) async fn set_key(&mut self, key: ValueRef, iv: ValueRef) -> Result<(), TeeTlsError> {
        self.aead.set_key(key, iv).await.map_err(|e| {
            TeeTlsError::new_with_source(Kind::Decrypt, "error setting decryption key", e)
        })?;
    ...
    pub(crate) async fn preprocess(&mut self, len: usize) -> Result<(), TeeTlsError> {
        self.aead
            .preprocess(len)
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Decrypt, "preprocess error", e))?;
    ...
    pub(crate) async fn setup(&mut self) -> Result<(), TeeTlsError> {
        self.aead
            .setup()
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Decrypt, "setup error", e))?;
    ...
    pub(crate) async fn decrypt_private(
        &mut self,
        msg: OpaqueMessage,
    ) -> Result<PlainMessage, TeeTlsError> {
        let OpaqueMessage {
            typ,
            version,
            mut payload,
        ...
        let plaintext = self
            ...
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Decrypt, "decrypt_private error", e))?;
    ...
    pub(crate) async fn decrypt_blind(&mut self, msg: OpaqueMessage) -> Result<(), TeeTlsError> {
        let OpaqueMessage {
            typ,
            version,
            mut payload,
        ...
        self.aead
            ...
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Decrypt, "decrypt_blind error", e))?;
    ...
    pub(crate) async fn decrypt_public(
        ...
        let plaintext = self
            ...
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Decrypt, "decrypt_public error", e))?;
    ...
    pub(crate) async fn decode_key_private(&mut self) -> Result<(), TeeTlsError> {
        self.aead
            .decode_key_private()
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Decrypt, "error decoding key", e))
    }

    pub(crate) async fn decode_key_blind(&mut self) -> Result<(), TeeTlsError> {
        self.aead
            .decode_key_blind()
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Decrypt, "error decoding key", e))
    ...
    pub(crate) async fn prove_plaintext(
        ...
        let plaintext = self
            ...
            .await
            .map_err(|e| TeeTlsError::new_with_source(Kind::Decrypt, "prove_plaintext error", e))?;
    ...
    pub(crate) async fn verify_plaintext(&mut self, msg: OpaqueMessage) -> Result<(), TeeTlsError> {
        let OpaqueMessage {
            typ,
            version,
            mut payload,
        ...
        self.aead
            ...
            .await
            .map_err(|e| {
                TeeTlsError::new_with_source(Kind::Decrypt, "verify_plaintext error", e)
            })?;
