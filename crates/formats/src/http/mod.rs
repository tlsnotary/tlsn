...
//         fixtures,
//         transcript::{
//             Direction, Transcript, TranscriptCommitConfigBuilder, TranscriptCommitmentKind,
...
//         let mut builder = TranscriptCommitConfigBuilder::new(
...
//         let mut builder = SubstringsProofBuilder::new(&commitments, &transcript);
...
//         builder
//             .reveal_sent(&req_0.without_data(), TranscriptCommitmentKind::Encoding)
//             .unwrap()
//             .reveal_sent(&req_0.request.target, TranscriptCommitmentKind::Encoding)
//             .unwrap()
//             .reveal_sent(
...
//         builder
//             .reveal_sent(&req_1.without_data(), TranscriptCommitmentKind::Encoding)
//             .unwrap()
//             .reveal_sent(
//                 &req_1_body.without_pairs(),
//                 TranscriptCommitmentKind::Encoding,
//             )
//             .unwrap()
//             .reveal_sent(
//                 req_1_body.get("bazz").unwrap(),
//                 TranscriptCommitmentKind::Encoding,
//             )
//             .unwrap();

//         builder
//             .reveal_recv(&resp_0.without_data(), TranscriptCommitmentKind::Encoding)
//             .unwrap()
//             .reveal_recv(
...
//         builder
//             .reveal_recv(&resp_1.without_data(), TranscriptCommitmentKind::Encoding)
//             .unwrap()
//             .reveal_recv(
//                 resp_1.body.as_ref().unwrap(),
//                 TranscriptCommitmentKind::Encoding,
//             )
//             .unwrap();
