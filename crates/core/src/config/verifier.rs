...
impl Mode {
    ...
    /// Checks if the verifier has to do a proxy setup.
    pub fn requires_proxy_setup(&self) -> bool {
        *self == Self::Proxy || *self == Self::Universal
    }
}
...
impl std::fmt::Display for Mode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Mode::Universal => write!(f, "Universal mode"),
        }
    }
}
